...
import skin.core.app.SkinCompatViewInflater;
import skin.core.annotation.NonNull;
import skin.core.annotation.Nullable;
import skin.core.app.SkinActivityLifecycle;
import skin.core.app.SkinLayoutInflater;
import skin.core.app.SkinWrapper;
import skin.core.load.SkinAssetsLoader;
import skin.core.load.SkinBuildInLoader;
import skin.core.load.SkinNoneLoader;
import skin.core.load.SkinPrefixBuildInLoader;
import skin.core.observe.SkinObservable;
import skin.core.utils.SkinPreference;
...
public class SkinCompatManager extends SkinObservable {
     ...
     *
     * @param inflater 在{@link SkinCompatViewInflater#createView(Context, String, String)}方法中调用.
     * @return
     */
     ...
     * 自定义View换肤时，可选择添加一个{@link SkinLayoutInflater}
     *
     * @param inflater 在{@link SkinCompatViewInflater#createView(Context, String, String)}方法中最先调用.
     * @return
     */
    @Deprecated
