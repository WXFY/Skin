...
public class SkinStatusBarUtils {
    ...
    private static boolean supportTranslucent() {
        return Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT
                ...
                && !(SkinDeviceUtils.isEssentialPhone() && Build.VERSION.SDK_INT < 26);
    }
    ...
    public static void translucent(Window window, @ColorInt int colorOn5x) {
        ...
        if (SkinNotchUtils.isNotchOfficialSupport()) {
            handleDisplayCutoutMode(window);
        }

        // 小米和魅族4.4 以上版本支持沉浸式
        // 小米 Android 6.0 ，开发版 7.7.13 及以后版本设置黑色字体又需要 clear FLAG_TRANSLUCENT_STATUS, 因此还原为官方模式
        if (SkinDeviceUtils.isFlymeLowerThan(8) || (SkinDeviceUtils.isMIUI() && Build.VERSION.SDK_INT < Build.VERSION_CODES.M)) {
...
//            }
    ...
    private static boolean isMIUICustomStatusBarLightModeImpl() {
        ...
        return SkinDeviceUtils.isMIUIV5() || SkinDeviceUtils.isMIUIV6() ||
                SkinDeviceUtils.isMIUIV7() || SkinDeviceUtils.isMIUIV8();
    }
    ...
    public static boolean supportTransclentStatusBar6() {
        return !(SkinDeviceUtils.isZUKZ1() || SkinDeviceUtils.isZTKC2016());
    }
    ...
    private static void initStatusBarHeight(Context context) {
        ...
        if (SkinDeviceUtils.isTablet(context)
                && sStatusBarHeight > SkinDisplayUtils.dp2px(context, STATUS_BAR_DEFAULT_HEIGHT_DP)) {
